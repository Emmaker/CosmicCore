...
function init()
    message.setHandler("cc_learnCodex", learnCodexHandler)
    message.setHandler("cc_getCodices", getCodices)

    self.knownCodices = player.getProperty("cc_knownCodices") or {}
...
function uninit()
    player.setProperty("cc_knownCodices", self.knownCodices)
end